...
export default function MainLayout({
  ...
  // While checking auth state, or if there's no user (which means a redirect is imminent), show a loader.
  if (isUserLoading || !user) {
    return (
  ...
  // Only if loading is complete and we have a user, render the main app layout.
  return (
